...
#[derive(Debug)]
pub struct YamYieldProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YamYieldProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YamYield processing");
    
    let mut processor = YamYieldProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YamYieldProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YamYieldProcessor::new(false);
